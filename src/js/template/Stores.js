...
export default class Stores extends BarbaPageBase {
  ...
  onEnterCompleted() {
    ...
    if ( this.locations.length > 0 ) {
      ...
      // this.latCenter = (parseFloat(this.locations[0].getAttribute('data-lat')) + parseFloat(this.locations[1].getAttribute('data-lat'))) / 2;
      // this.lngCenter = (parseFloat(this.locations[0].getAttribute('data-lng')) + parseFloat(this.locations[1].getAttribute('data-lng'))) / 2;
  ...
  loadGmaps() {
    ...
    if ( !window.googleMapsLoaded ) {
      ...
      script.src = 'https://maps.google.com/maps/api/js?key=AIzaSyC30nnqC_nxh8v5p4jQpZEE2KyZUhl2NLU';
